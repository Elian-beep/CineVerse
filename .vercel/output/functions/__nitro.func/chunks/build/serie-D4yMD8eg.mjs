...
import { f as useTvsStore, d as checkBookmarked, g as getStream, _ as _export_sfc } from './server.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "custom-background flex flex-col w-100 flex flex-col justify-items-end" }, _attrs))} data-v-08a666af><div class="custom-background-size relative bg-cover bg-no-repeat bg-center sm:py-24 sm:px-5 sm:h-screen sm:bg-fixed sm:grid" style="${ssrRenderStyle(`background-image: url('https://image.tmdb.org/t/p/original${(_a = unref(tvStore).getPopularTvs[unref(indexStream)]) == null ? void 0 : _a.poster_path}');`)}" data-v-08a666af><div class="custom-background-desc w-full absolute bottom-0" data-v-08a666af><div class="w-96 bg-green mx-auto flex flex-col gap-4 sm:m-0 sm:ml-20 sm:gap-6 sm:w-1/2 md:w-1/3" data-v-08a666af><span class="text-content text-3xl font-bold sm:text-5xl" data-v-08a666af>${ssrInterpolate((_b = unref(tvStore).getPopularTvs[unref(indexStream)]) == null ? void 0 : _b.name)}</span><p class="text-subtitle text-base sm:text-xl" data-v-08a666af>${ssrInterpolate((_c = unref(tvStore).getPopularTvs[unref(indexStream)]) == null ? void 0 : _c.overview)}</p><div class="flex gap-4 sm:mt-6 sm:gap-6" data-v-08a666af><a${ssrRenderAttr("href", `https://www.youtube.com/results?search_query=${(_d = unref(tvStore).getPopularTvs[unref(indexStream)]) == null ? void 0 : _d.name} Trailer`)} target="\u201D_blank\u201D" class="custom-hover-trailer transition-transform transition-300 transition-ease bg-primary rounded-full px-4 py-3 flex gap-2 items-center text-app font-bold" data-v-08a666af>`);
      _push(ssrRenderComponent(unref(FontAwesomeIcon), { icon: unref(faPlay) }, null, _parent));
      _push(` Trailer </a><button class="bg-transparent rounded-full px-4 py-3 text-primary flex gap-2 items-center border-solid border-2 border-primary sm:hover:bg-primary sm:hover:bg-opacity-15" data-v-08a666af>`);
      _push(ssrRenderComponent(unref(FontAwesomeIcon), {
        icon: unref(btnConfigBookmarked).iSave ? unref(faBookmark) : unref(faPlusCircle)
      }, null, _parent));
      _push(`<span data-v-08a666af>${ssrInterpolate(unref(btnConfigBookmarked).iSave ? unref(btnConfigBookmarked).titleUnsave : unref(btnConfigBookmarked).titleSave)}</span></button></div></div></div></div></div>`);
    };
  }
});
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/main/PopularTv.vue");
  return _sfc_setup$1 ? _sfc_setup$1(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-08a666af"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_MainPopularTv = __nuxt_component_0;
      ...
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_MainPopularTv, null, null, _parent));
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_MainGroupFilter, {
              ...
              filter: unref(tvStore).getCurrentGenre,
              "values-filter": unref(tvStore).getGenres,
              onHandleFilter: handleFilter
            }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_MainGroupStream, {
              class: "pt-0",
              "grup-stream": unref(tvStore).getTvs
            }, null, _parent2, _scopeId));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/serie.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=serie-D4yMD8eg.mjs.map
