...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Exemlpo de desc de teste"}],"link":[],"style":[],"script":[],"noscript":[],"title":"CineVerse"};
